<?php /* Smarty version 2.6.12, created on 2016-05-05 16:07:37
...
unset($_smarty_tpl_vars);
 ?>
    <div class="vitrine-index bg-servico-orcamento bg-interna">
    ...
    <section class="container">
        <div class="width-default mg-bt-50">
            <div class="col-xs-12 col-sm-3 col-md-3 pd-lf-none">
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "../inc/menu-lateral-contato.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>   
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 pd-lf-none">
                        <h1 class="titulo-destaque">Formulário de contato</h1>
                ...
                <div class="row bloco-atributos bloco-servico bd-none">
                    <p class="txt-default">Preencha o formulário ao lado com os seus dados e envie sua crítica, dúvida ou sugestão para nossa equipe. Analisaremos seu e-mail e responderemos o mais breve possível</p>
                    <?php $_smarty_tpl_vars = $this->_tpl_vars;
