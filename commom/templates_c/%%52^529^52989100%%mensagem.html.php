<?php /* Smarty version 2.6.12, created on 2016-04-19 13:34:32
...
<?php if ($this->_tpl_vars['tipo'] == 'html' && $this->_tpl_vars['formulario'] && $this->_tpl_vars['form']['submit']):  echo '
<script>
...
<?php endif;  if ($this->_tpl_vars['tipo'] == 'html'): ?>
...
;<?php endif;  if ($this->_tpl_vars['fecha']): ?>window.close();<?php endif; ?>
