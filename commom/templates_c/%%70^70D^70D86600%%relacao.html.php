<?php /* Smarty version 2.6.12, created on 2016-05-05 16:05:56
         compiled from admin_planobweb/noticias/relacao.html */ ?>
...
?>
                    <a class="<?php if ($this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']] == $_GET['p']): ?> link-pag-ativo <?php endif; ?>" href="novo_adm_usuario.php?acao=pesquisar&p=<?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
...
">visualizar</a>  -->
                                    <a class="cor-tr-btn btn-acoes" target="_blank" href="noticia/<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['urlAmigavel']; ?>
">visualizar</a> 
...
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
?>
                        <a class="<?php if ($this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']] == $_GET['p']): ?> link-pag-ativo <?php endif; ?>" href="novo_adm_noticias.php?acao=pesquisar&p=<?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
"><?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
</a>
                    <?php endfor; endif; ?>
                <?php endif; ?>
