<?php /* Smarty version 2.6.12, created on 2016-04-19 14:50:10
         compiled from servicos-terceirizados.html */ ?>
<!DOCTYPE HTML>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
 ...
 ?>
    ...
    <div class="vitrine-index bg-servico-interna">
        <div class="width-default">
            <p class="titulo-banner-interna">Serviços de terceirizados</p>
...
servicos" class="link-breadcrumb">• Serviços</a></li>
                    <li class="linha-breadcrumb linha-breadcrumb-ativo">• Serviços Terceirizados</li>
                </ul>
            </div>
        </div>
    </div>
    <section class="container">
        <div class="width-default">
            <div class="row">
                <h1 class="titulo-destaque">Serviços de terceirizados</h1>
                <div class="max-width-title"><span class="linha-titulo-cinza"></span><span class="linha-titulo-laranja"></span></div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-2 col-md-2 pd-lf-none"></div>
...
commom/img/veja-tambem.jpg" alt="Escolta armada">
                                        </a>
                                    </div>
                                    <h2 class="titulo-veja-tbm pull-left"><a href="<?php echo $this->_tpl_vars['URL']; ?>
escolta-armada">Escolta armada</a></h2>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4 pd-none">
                                <div class="row config-bloco-servico">
