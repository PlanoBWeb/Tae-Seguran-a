...
include_once "classes/novo_Usuario.class.php";
...
if ($_POST["acao"] == "logar")
{
	...
	echo "<script>location.href='novo_adm_index.php';</script>";
}

session_start();
if($_SESSION['login'] == "" OR $_SESSION['senha'] == "" OR $_SESSION['id'] == "")
{
	$smarty->display('admin_planobweb/login.html');
	die();
}
