...
if($lPermissao)
{
	...
	if($acao != "logout")
	{
		...
		$permissao['novo_adm_usuario']['cadastrar'] 		= array("A");
		$permissao['novo_adm_usuario']['editar'] 		= array("A");
		$permissao['novo_adm_usuario']['pesquisar'] 		= array("A");
		$permissao['novo_adm_usuario']['exclui'] 		= array("A");
		$permissao['novo_adm_usuario']['senha'] 			= array("A");
		$permissao['novo_adm_usuario']['visualizar']		= $permissao['novo_adm_usuario']['pesquisar'];
		$permissao['novo_adm_usuario']['gravar'] 		= $permissao['novo_adm_usuario']['editar'];


		$permissao['novo_adm_cliente']['cadastrar'] 		= array("A","M","F");
		$permissao['novo_adm_cliente']['editar'] 		= array("A","M","F","D");
		$permissao['novo_adm_cliente']['busca'] 			= array("A","M","F","D");
		$permissao['novo_adm_cliente']['pesquisar'] 		= array("A");
		$permissao['novo_adm_cliente']['exclui'] 		= array("A");
		$permissao['novo_adm_cliente']['visualizar']		= $permissao['novo_adm_cliente']['pesquisar'];
		$permissao['novo_adm_cliente']['gravar'] 		= $permissao['novo_adm_cliente']['editar'];
		...
		$smarty->assign("menuPesUsuario", in_array($lPermissao, $permissao['novo_adm_usuario']['pesquisar']));
		$smarty->assign("menuAddUsuario", in_array($lPermissao, $permissao['novo_adm_usuario']['cadastrar']));
		$smarty->assign("menuExcUsuario", in_array($lPermissao, $permissao['novo_adm_usuario']['exclui']));
		$smarty->assign("menuEdiUsuario", in_array($lPermissao, $permissao['novo_adm_usuario']['editar']));
	}
